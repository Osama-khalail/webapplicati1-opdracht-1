    ...
    <main>
        <nav class="top-nav">
            <div class="bovenste-gedeelte">
                <div class="bovenste-gedeelte-boxen links">
                    <div class="logo"><img src="img/logo.jpeg" alt=""></div>
                </div>
                <div class="bovenste-gedeelte-boxen midden">
                    <div class="boven-menu">
        ...
        <footer class="footer-distributed">
            ...
            <div class="footer-right">
                ...
                <p class="footer-company-about">
                    ...
                    Zorba is een streetfoodrestaurant dat is gevestigd in de stad Groningen. Het restaurant is vernoemd
                    naar Zorba de Griek, een bekend boek van de Griekse schrijver Nikos Kazantzakis.
                </p>
